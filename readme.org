...
2. adjust dylos.sh to write to your own data store. Or, hey, ping me if
you want to experiment with my data ingest system.
...
license: AGPL3. This ain't commercial work.
